...
export default class LinkFormView extends View {
   ...
   * which corresponds to {@link module:link/AlightLinkCommand~AlightLinkCommand#manualDecorators manual decorators}
   ...
   * @param AlightLinkCommand Reference to {@link module:link/AlightLinkCommand~AlightLinkCommand}.
   * @param validators  Form validators used by {@link #isValid}.
   */
  constructor(locale: Locale, AlightLinkCommand: AlightLinkCommand, validators: Array<LinkFormValidatorCallback>) {
    super(locale);
    ...
    this._manualDecoratorSwitches = this._createManualDecoratorSwitches(AlightLinkCommand);
    this.children = this._createFormChildren(AlightLinkCommand.manualDecorators);
    ...
    if (AlightLinkCommand.manualDecorators.length) {
   ...
   * {@link module:link/AlightLinkCommand~AlightLinkCommand#manualDecorators manual link decorators}
  ...
  private _createUrlInput(): LabeledFieldView<InputTextView> {
    ...
    labeledInput.label = t('AlightLink URL');
   ...
   * made based on {@link module:link/AlightLinkCommand~AlightLinkCommand#manualDecorators}.
   *
   * @param AlightLinkCommand A reference to the link command.
   * @returns ViewCollection of switch buttons.
   */
  private _createManualDecoratorSwitches(AlightLinkCommand: AlightLinkCommand): ViewCollection<SwitchButtonView> {
    const switches = this.createCollection<SwitchButtonView>();

    for (const manualDecorator of AlightLinkCommand.manualDecorators) {
      ...
      switchButton.bind('isOn').toMany([manualDecorator, AlightLinkCommand], 'value', (decoratorValue, commandValue) => {
   ...
   *
   * If {@link module:link/AlightLinkCommand~AlightLinkCommand#manualDecorators manual decorators} are configured in the editor, it creates an
