// tests/alight-checkbox-component-view.spec.ts
...
describe('CheckboxView', () => {
  ...
  describe('execute event', () => {
    it('should fire execute and toggle isChecked on click when enabled', (done) => {
      type ExecuteEvent = { name: 'execute'; args: [] };
      const executeSpy = jasmine.createSpy<() => void>('execute');
