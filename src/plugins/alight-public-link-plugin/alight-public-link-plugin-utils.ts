...
/**
 * Checks if the selection has the 'alightPublicLinkPlugin' attribute.
 * This attribute is used to indicate that a public link is applied.
 *
 * @param selection - The current selection in the editor.
 * @returns True if the selection has the 'alightPublicLinkPlugin' attribute, false otherwise.
 */
...
/**
 * Retrieves the value of the 'alightPublicLinkPlugin' attribute from the selection.
