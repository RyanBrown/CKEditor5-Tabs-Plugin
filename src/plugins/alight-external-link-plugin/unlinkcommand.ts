// src/plugins/alight-external-link-plugin/unlinkcommand.ts
...
/**
 * The unlink command. It is used by the {@link module:link/link~AlightExternalLinkPlugin link feature}.
