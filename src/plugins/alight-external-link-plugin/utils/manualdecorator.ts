// src/plugins/alight-external-link-plugin/utils/manualdecorator.ts
 ...
 * These decorators are kept as collections in {@link module:link/AlightExternalLinkPluginCommand~AlightExternalLinkPluginCommand#manualDecorators}.
 */
