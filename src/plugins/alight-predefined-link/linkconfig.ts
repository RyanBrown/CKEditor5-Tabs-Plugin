...
/**
 * The configuration of the {@link module:link/link~AlightPredefinedLink link feature}.
 *
 * ```ts
 * ClassicEditor
 * 	.create( editorElement, {
 * 		link:  ... // AlightPredefinedLink feature configuration.
 * 	} )
 * 	.then( ... )
 * 	.catch( ... );
 * ```
...
export interface LinkConfig {
   ...
   *
   * AlightPredefinedLink decorators are defined as objects with key-value pairs, where the key is the name provided for a given decorator and the
...
export interface LinkDecoratorAutomaticDefinition {
  ...
  /**
   * AlightPredefinedLink decorator type. It is `'automatic'` for all automatic decorators.
   */
  mode: 'automatic';
...
export interface LinkDecoratorManualDefinition {
  ...
  /**
   * AlightPredefinedLink decorator type. It is `'manual'` for all manual decorators.
   */
  mode: 'manual';
