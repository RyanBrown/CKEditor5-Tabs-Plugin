...
export default class LinkFormView extends View {
   ...
   * which corresponds to {@link module:link/AlightPredefinedLinkCommand~AlightPredefinedLinkCommand#manualDecorators manual decorators}
   ...
   * @param AlightPredefinedLinkCommand Reference to {@link module:link/AlightPredefinedLinkCommand~AlightPredefinedLinkCommand}.
   * @param validators  Form validators used by {@link #isValid}.
   */
  constructor(locale: Locale, AlightPredefinedLinkCommand: AlightPredefinedLinkCommand, validators: Array<LinkFormValidatorCallback>) {
    super(locale);
    ...
    this._manualDecoratorSwitches = this._createManualDecoratorSwitches(AlightPredefinedLinkCommand);
    this.children = this._createFormChildren(AlightPredefinedLinkCommand.manualDecorators);
    ...
    if (AlightPredefinedLinkCommand.manualDecorators.length) {
   ...
   * {@link module:link/AlightPredefinedLinkCommand~AlightPredefinedLinkCommand#manualDecorators manual link decorators}
  ...
  private _createUrlInput(): LabeledFieldView<InputTextView> {
    ...
    labeledInput.label = t('AlightPredefinedLink URL');
   ...
   * made based on {@link module:link/AlightPredefinedLinkCommand~AlightPredefinedLinkCommand#manualDecorators}.
   *
   * @param AlightPredefinedLinkCommand A reference to the link command.
   * @returns ViewCollection of switch buttons.
   */
  private _createManualDecoratorSwitches(AlightPredefinedLinkCommand: AlightPredefinedLinkCommand): ViewCollection<SwitchButtonView> {
    const switches = this.createCollection<SwitchButtonView>();

    for (const manualDecorator of AlightPredefinedLinkCommand.manualDecorators) {
      ...
      switchButton.bind('isOn').toMany([manualDecorator, AlightPredefinedLinkCommand], 'value', (decoratorValue, commandValue) => {
   ...
   *
   * If {@link module:link/AlightPredefinedLinkCommand~AlightPredefinedLinkCommand#manualDecorators manual decorators} are configured in the editor, it creates an
