// src/plugins/alight-email-link-plugin/tests/alight-email-link-plugin-editing.spec.ts
...
describe('AlightEmailLinkPluginCommand', () => {
  ...
  //       '<paragraph>foo[<$text alightEmailLinkPlugin=\'{"url":"https://example.com","orgName":"Example Org"}\'>bar</$text>]baz</paragraph>'
  //     );
  //   });
  ...
  //     setData(
  //       editor.model,
  //       `<paragraph>foo[<$text alightEmailLinkPlugin='${JSON.stringify(oldLinkData)}'>bar</$text>]baz</paragraph>`
  //     );
  //     const command = editor.commands.get('alightEmailLinkPlugin');
  //     command.execute(newLinkData);

  //     expect(getData(editor.model)).toBe(
  //       `<paragraph>foo[<$text alightEmailLinkPlugin='${JSON.stringify(newLinkData)}'>bar</$text>]baz</paragraph>`
  //     );
  //   });
  ...
  //     setData(
  //       editor.model,
  //       `<paragraph>foo<$text alightEmailLinkPlugin='${JSON.stringify(linkData)}'>b[]ar</$text>baz</paragraph>`
  //     );
  //     const newLinkData = {
  //       url: 'https://new-example.com',
  //       orgName: 'New Org'
  ...
  //     expect(getData(editor.model)).toBe(
  //       `<paragraph>foo<$text alightEmailLinkPlugin='${JSON.stringify(newLinkData)}'>b[]ar</$text>baz</paragraph>`
  //     );
  //   });
  ...
  //     setData(
  //       editor.model,
  //       `<paragraph>foo[<$text alightEmailLinkPlugin='${JSON.stringify(linkData)}'>bar (Example Org)</$text>]baz</paragraph>`
  //     );
  //     const command = editor.commands.get('alightEmailLinkPlugin');
  //     command.execute();
