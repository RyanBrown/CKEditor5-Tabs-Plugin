...
describe('AlightPredefinedLinkPluginCommand', () => {
  ...
  describe('value', () => {
    ...
    it('should be set to link attributes when selection has link', () => {
      ...
      setData(
        editor.model,
        `<paragraph><$text alightPredefinedLinkPlugin='${JSON.stringify(linkData)}'>foo[]bar</$text></paragraph>`
      );
      const command = editor.commands.get('alightPredefinedLinkPlugin');
  ...
  //       '<paragraph>foo[<$text alightPredefinedLinkPlugin=\'{"url":"https://example.com","orgName":"Example Org"}\'>bar</$text>]baz</paragraph>'
  //     );
  //   });
  ...
  //     setData(
  //       editor.model,
  //       `<paragraph>foo[<$text alightPredefinedLinkPlugin='${JSON.stringify(oldLinkData)}'>bar</$text>]baz</paragraph>`
  //     );
  //     const command = editor.commands.get('alightPredefinedLinkPlugin');
  //     command.execute(newLinkData);

  //     expect(getData(editor.model)).toBe(
  //       `<paragraph>foo[<$text alightPredefinedLinkPlugin='${JSON.stringify(newLinkData)}'>bar</$text>]baz</paragraph>`
  //     );
  //   });
  ...
  //     setData(
  //       editor.model,
  //       `<paragraph>foo<$text alightPredefinedLinkPlugin='${JSON.stringify(linkData)}'>b[]ar</$text>baz</paragraph>`
  //     );
  //     const newLinkData = {
  //       url: 'https://new-example.com',
  //       orgName: 'New Org'
  ...
  //     expect(getData(editor.model)).toBe(
  //       `<paragraph>foo<$text alightPredefinedLinkPlugin='${JSON.stringify(newLinkData)}'>b[]ar</$text>baz</paragraph>`
  //     );
  //   });
  ...
  //     setData(
  //       editor.model,
  //       `<paragraph>foo[<$text alightPredefinedLinkPlugin='${JSON.stringify(linkData)}'>bar (Example Org)</$text>]baz</paragraph>`
  //     );
  //     const command = editor.commands.get('alightPredefinedLinkPlugin');
  //     command.execute();
