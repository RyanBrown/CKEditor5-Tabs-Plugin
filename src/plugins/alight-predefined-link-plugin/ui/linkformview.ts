// src/plugins/alight-predefined-link-plugin/ui/linkformview.ts
import {
  ButtonView,
  FocusCycler,
  LabeledFieldView,
...
export default class LinkFormView extends View {
   ...
   * which corresponds to {@link module:link/AlightPredefinedLinkPluginCommand~AlightPredefinedLinkPluginCommand#manualDecorators manual decorators}
   ...
   * @param AlightPredefinedLinkPluginCommand Reference to {@link module:link/AlightPredefinedLinkPluginCommand~AlightPredefinedLinkPluginCommand}.
   * @param validators  Form validators used by {@link #isValid}.
   */
  constructor(locale: Locale, AlightPredefinedLinkPluginCommand: AlightPredefinedLinkPluginCommand, validators: Array<LinkFormValidatorCallback>) {
    super(locale);
    ...
    this._manualDecoratorSwitches = this._createManualDecoratorSwitches(AlightPredefinedLinkPluginCommand);
    this.children = this._createFormChildren(AlightPredefinedLinkPluginCommand.manualDecorators);
    ...
    if (AlightPredefinedLinkPluginCommand.manualDecorators.length) {
   ...
   * {@link module:link/AlightPredefinedLinkPluginCommand~AlightPredefinedLinkPluginCommand#manualDecorators manual link decorators}
  ...
  private _createUrlInput(): LabeledFieldView<InputTextView> {
    ...
    labeledInput.label = t('AlightPredefinedLinkPlugin URL');
   ...
   * made based on {@link module:link/AlightPredefinedLinkPluginCommand~AlightPredefinedLinkPluginCommand#manualDecorators}.
   *
   * @param AlightPredefinedLinkPluginCommand A reference to the link command.
  ...
  private _createManualDecoratorSwitches(AlightPredefinedLinkPluginCommand: AlightPredefinedLinkPluginCommand): ViewCollection<SwitchButtonView> {
    ...
    for (const manualDecorator of AlightPredefinedLinkPluginCommand.manualDecorators) {
      ...
      switchButton.bind('isOn').toMany([manualDecorator, AlightPredefinedLinkPluginCommand], 'value', (decoratorValue, commandValue) => {
   ...
   *
   * If {@link module:link/AlightPredefinedLinkPluginCommand~AlightPredefinedLinkPluginCommand#manualDecorators manual decorators} are configured in the editor, it creates an
