// src/plugins/alight-new-document-link-plugin/alight-new-document-link-plugin-utils.ts
...
/**
 * Checks if the selection has the 'alightNewDocumentLinkPlugin' attribute.
 * This attribute is used to indicate that a public link is applied.
 *
 * @param selection - The current selection in the editor.
 * @returns True if the selection has the 'alightNewDocumentLinkPlugin' attribute, false otherwise.
 */
export function hasLinkAttribute(selection: any): boolean {
  return selection.hasAttribute('alightNewDocumentLinkPlugin');
}

/**
 * Retrieves the value of the 'alightNewDocumentLinkPlugin' attribute from the selection.
...
export function getLinkAttributeValue(selection: any): { url: string; orgName?: string } | undefined {
  const value = selection.getAttribute('alightNewDocumentLinkPlugin');
