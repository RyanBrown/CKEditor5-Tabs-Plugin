// src/plugins/alight-balloon-link-plugin/modal-content/balloon-link-modal-ContentManager.ts
import { LinkManager } from './balloon-link-modal-LinkManager';
import { BalloonLink } from './balloon-link-modal-types';
import { SearchManager } from './balloon-link-modal-SearchManager';
import { PaginationManager } from './balloon-link-modal-PaginationManager';
...
export class ContentManager implements LinkManager {
  private selectedLink: BalloonLink | null = null;
  private predefinedLinksData: BalloonLink[] = predefinedLinksData.predefinedLinksDetails;
  private filteredLinksData: BalloonLink[] = [...this.predefinedLinksData];
  ...
  private handleSearchResults = (filteredData: BalloonLink[]): void => {
  ...
  private buildLinkItemMarkup(link: BalloonLink): string {
