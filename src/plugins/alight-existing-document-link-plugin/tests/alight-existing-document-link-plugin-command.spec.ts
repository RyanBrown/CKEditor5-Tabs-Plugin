// src/plugins/alight-predefined-link-plugin/tests/alight-predefined-link-plugin-command.spec.ts
...
describe('AlightExistingDocumentLinkPluginCommand', () => {
  ...
  //       '<paragraph>foo[<$text alightExistingDocumentLinkPlugin=\'{"url":"https://example.com","orgName":"Example Org"}\'>bar</$text>]baz</paragraph>'
  //     );
  //   });
  ...
  //       writer.setAttribute('alightExistingDocumentLinkPlugin', linkData, range);
  //     });
  ...
  //     setData(
  //       editor.model,
  //       `<paragraph>foo[<$text alightExistingDocumentLinkPlugin='${JSON.stringify(oldLinkData)}'>bar</$text>]baz</paragraph>`
  //     );
  //     const command = editor.commands.get('alightExistingDocumentLinkPlugin');
  //     command.execute(newLinkData);

  //     expect(getData(editor.model)).toBe(
  //       `<paragraph>foo[<$text alightExistingDocumentLinkPlugin='${JSON.stringify(newLinkData)}'>bar</$text>]baz</paragraph>`
  //     );
  //   });
  ...
  //     setData(
  //       editor.model,
  //       `<paragraph>foo<$text alightExistingDocumentLinkPlugin='${JSON.stringify(linkData)}'>b[]ar</$text>baz</paragraph>`
  //     );
  //     const newLinkData = {
  //       url: 'https://new-example.com',
  //       orgName: 'New Org'
  ...
  //     expect(getData(editor.model)).toBe(
  //       `<paragraph>foo<$text alightExistingDocumentLinkPlugin='${JSON.stringify(newLinkData)}'>b[]ar</$text>baz</paragraph>`
  //     );
  //   });
  ...
  //     setData(
  //       editor.model,
  //       `<paragraph>foo[<$text alightExistingDocumentLinkPlugin='${JSON.stringify(linkData)}'>bar (Example Org)</$text>]baz</paragraph>`
  //     );
  //     const command = editor.commands.get('alightExistingDocumentLinkPlugin');
  //     command.execute();
