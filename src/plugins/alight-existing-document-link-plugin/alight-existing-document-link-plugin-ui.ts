...
export default class AlightExistingDocumentLinkPluginUI extends Plugin {
  ...
  private _setupToolbarButton(): void {
    ...
    editor.ui.componentFactory.add('alightExistingDocumentLinkPlugin', locale => {
      ...
      if (!command) {
        console.warn('AlightExistingDocumentLinkPlugin command not found');
        return button;
      }
  ...
  private _createActionsView(): ActionsView {
    ...
    const command = editor.commands.get('alightExistingDocumentLinkPlugin') as AlightExistingDocumentLinkPluginCommand;
  ...
  private _showBalloon(): void {
    ...
    const command = this.editor.commands.get('alightExistingDocumentLinkPlugin') as AlightExistingDocumentLinkPluginCommand;
  ...
  // In AlightExistingDocumentLinkPluginUI class, change the _showModal method to:
